      ...
      >
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 flex-wrap">
            ...
            <UBadge v-if="receita.parcelas > 0" :label="`${receita.parcela_atual}/${receita.parcelas}`" color="purple" variant="soft" size="xs"
              icon="i-heroicons-queue-list" />
            <UBadge v-else-if="receita.fixa" label="Fixa" color="info" variant="soft" size="xs"
